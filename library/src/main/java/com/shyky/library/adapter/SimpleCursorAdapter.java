...
public class SimpleCursorAdapter extends ResourceCursorAdapter {
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        final android.widget.SimpleCursorAdapter.ViewBinder binder = mViewBinder;
    ...
    /**
     * Returns the {@link android.widget.SimpleCursorAdapter.ViewBinder} used to bind data to views.
     *
